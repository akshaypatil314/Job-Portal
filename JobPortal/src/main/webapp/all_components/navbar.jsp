		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<c:if test="${ userObject.role eq 'admin' }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="view_jobs.jsp"><i
			...
			<form class="d-flex">
				...
				<c:if test="${userObject.role eq 'User' }">
					<a href="#" class="btn btn-light m-1" data-bs-toggle="modal"
						...
						<i class="fa-solid fa-user p-1"></i>${userObject.name }</a>
					<a href="logout" class="btn btn-light m-1">
					<i class="fa-solid fa-arrow-right-to-bracket p-1"></i>Logout</a>
				</c:if>
				...
				<c:if test="${empty userObject }">
					...
					<a href="signup.jsp" class="btn btn-light m-1"><i
						class="fa-solid fa-user p-1"></i>Signup</a>
				</c:if>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="edit_profile.jsp?id=${userObject.id }" class="btn btn-primary">Edit</a>
			</div>
		</div>
	</div>
</div>